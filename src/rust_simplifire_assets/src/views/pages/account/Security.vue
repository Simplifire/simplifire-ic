  ...
  <div class="container-fluid mt-4">
    ...
    <div class="row mt-4">
      ...
      <div class="col-sm-6">
        ...
        <vmd-input type="text" placeholder="Enter your answer" />
      </div>
          ...
          <div class="card-body p-3">
            ...
            <div class="card">
              <div class="card-body border-radius-lg bg-gradient-dark p-3">
                ...
                <vmd-button color="light" variant="gradient" class="mb-0"
                  >Contact Us</vmd-button
                >
              </div>
            </div>
          </div>
      ...
      <div class="col-md-6 pb-3">
        <div class="card">
          ...
          <div class="card-body p-3">
            ...
            <vmd-input type="password" placeholder="Current Password" />
            <label class="form-label">New password</label>
            <vmd-input type="password" placeholder="New Password" />
            <label class="form-label">Confirm new password</label>
            <vmd-input type="password" placeholder="Confirm password" />
            <vmd-button
              color="dark"
              variant="gradient"
              fullWidth
