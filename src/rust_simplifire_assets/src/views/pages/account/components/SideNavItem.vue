<template>
  ...
  <div class="card mt-4" id="basic-info">
    ...
    <div class="card-body pt-0">
      <div class="row">
        <div class="col-6">
          <vmd-input variant="static" label="First Name" placeholder="Alec" />
        </div>
        <div class="col-6">
          <vmd-input
            variant="static"
  ...
  <div class="card mt-4" id="password">
    ...
    <div class="card-body pt-0">
      <div class="mb-3">
        <vmd-input type="password" label="Current Password" />
      </div>
      <div class="mb-3">
        <vmd-input type="password" label="New Password" />
      </div>
      <div class="mb-3">
        <vmd-input type="password" label="Confirm password" />
      </div>
  ...
  <div class="card mt-4" id="2fa">
    <div class="card-header d-flex">
      ...
      <vmd-badge color="success" class="ms-auto">Enabled</vmd-badge>
    </div>
    <div class="card-body">
      <div class="d-flex">
  ...
  <div class="card mt-4" id="accounts">
    ...
    <div class="card-body pt-0">
      <div class="d-flex">
        <vmd-avatar class="width-48-px" :img="img1" alt="logo_slack" />
      ...
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vmd-avatar class="width-48-px" :img="img2" alt="logo_spotify" />
        <div class="my-auto ms-3">
          <div class="h-100">
      ...
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vmd-avatar class="width-48-px" :img="img3" alt="logo_atlassian" />
        <div class="my-auto ms-3">
          <div class="h-100">
      ...
      <hr class="horizontal dark" />
      <div class="d-flex">
        <vmd-avatar class="width-48-px" :img="img4" alt="logo_asana" />
        <div class="my-auto ms-3">
          <div class="h-100">
  ...
  <div class="card mt-4" id="sessions">
    ...
    <div class="card-body pt-0">
      <div class="d-flex align-items-center">
        ...
        <vmd-badge color="success" size="sm" class="my-auto ms-auto me-3"
          >Active</vmd-badge
        >
