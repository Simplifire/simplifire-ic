        ...
        <div class="card mb-4">
          <div class="card-header p-3 pb-0">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <vmd-button color="dark" variant="gradient" class="ms-auto mb-0"
                >Invoice</vmd-button
              >
            </div>
          </div>
          <div class="card-body p-3 pt-0">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-12">
                <div class="d-flex">
                  ...
                  <div>
                    ...
                    <vmd-badge color="success" variant="gradient" size="sm"
                      >Delivered</vmd-badge
                    >
                  </div>
                </div>
              ...
              <div class="col-lg-6 col-md-6 col-12 my-auto text-end">
                <vmd-button color="dark" variant="gradient" class="mb-0"
